...
$brandinstance->setstatus(1);
$brands = $brandinstance->read()->get_result()->fetch_all(MYSQLI_ASSOC);



$lastproductinstance = new product;
$lastproductinstance->getCreated_at();
$products = $lastproductinstance->read()->fetch_all(MYSQLI_ASSOC);
...
<!-- Slider Start -->
    <div class="slider-area">
      <div class="slider-active owl-dot-style owl-carousel">
        <div
          class="single-slider ptb-240 bg-img"
        ...
        <div
          class="single-slider ptb-240 bg-img"
          style="background-image: url(assets/img/slider/slider-1-1.jpg)"
        >
          <div class="container">
            <div class="slider-content slider-animated-1">
              <h1 class="animated">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="blog-single mb-30">
              ...
              <div class="blog-content pt-25">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisici elit, sed do
                  eius tempor incididunt ut labore et dolore
                </p>
                <a href="#">Read More</a>
              </div>
            </div>
