...
use App\Database\Models\Constracts\crud;

class User extends Model implements crud {
    private $id, $first_name , $last_name, $email , $phone, $password, $gender,
     $verification_code , $status ,$image, $email_verified_at, $created_at,$updated_at;
    ...
    public function create()
    {
        ...
        // print_r($this);die;
        $stmt->bind_param('ssssssi',$this->first_name,$this->last_name,$this->email,$this->phone,$this->password,$this->gender,$this->verification_code);
    ...
    public function updateemail_code()
    {
