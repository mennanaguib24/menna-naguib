...
$productpage->setStatus(1);
$products= $productpage->get()->get_result()->fetch_all(MYSQLI_ASSOC);
if($_GET){
    if (isset($_GET['brand'])) {
      $productpage->setBrand_id($_GET['brand']);
      $products= $productpage->getProductBrand()->get_result()->fetch_all(MYSQLI_ASSOC);
    }else {
      # code...
                  ...
                  <ul id="faq">
                    <li>
                      <a
                        ...
                        >Morning Tea <i class="ion-ios-arrow-down"></i
                      ></a>
                      <ul
                        id="shop-catigory-1"
                    ...
                    <li>
                      <a
                        ...
                        >Tea Trends<i class="ion-ios-arrow-down"></i
                      ></a>
                    ...
                    <li>
                      <a
                        ...
                        >Most Tea Map <i class="ion-ios-arrow-down"></i
                      ></a>
