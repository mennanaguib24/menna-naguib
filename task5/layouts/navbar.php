              ...
              <div class="header-bottom-right">
                <div class="main-menu">
                  <nav>
                    ...
                    <li class="top-hover"><a href="blog-left-sidebar.php">about</a>
                    </li>
                    <li><a href="blog-masonry.php">contact</a></li>
                    </ul>      
                  </nav>
                </div>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            <a href="blog-left-sidebar.php">left sidebar</a>
                          </li>
                          <li>
                            <a href="blog-right-sidebar.php">right sidebar</a>
                          </li>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="blog-details-audio.php">audio post</a>
                          </li>
                          <li>
                            <a href="blog-details-video.php">video post</a>
                          </li>
                          <li>
                            <a href="blog-details-gallery.php">gallery post</a>
                          </li>
                          <li><a href="blog-details-link.php">link post</a></li>
                          <li>
                            <a href="blog-details-quote.php">quote post</a>
                          </li>
                        </ul>
                      </li>
                    </ul>
